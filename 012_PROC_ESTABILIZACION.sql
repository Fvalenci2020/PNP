...
SELECT	T1.idversion IdVersionPreciosPNP,t1.IdEfact,t1.fechaefact,t1.IdVersionEFact,t1.PNP_MesIndexacion,t1.PNP_Version,T1.IdDistribuidora,T1.IdGeneradora,t1.IdCodigoContrato,t1.IdPuntoRetiro,t1.IdSistemaZonal,
...
SELECT	T1.idversion IdVersionPreciosDef,t1.IdEfact,t1.fechaefact,t1.IdVersionEFact,t1.PNP_MesIndexacion,t1.PNP_Version,T1.IdDistribuidora,T1.IdGeneradora,t1.IdCodigoContrato,t1.IdPuntoRetiro,t1.IdSistemaZonal,
	SUM(T1.ENERGIA*T1.FactorFR) ENERGIA,SUM(T1.POTENCIA*T1.FactorFR) POTENCIA,
	sum(t1.EPC) EPC,sum(t1.PPC) PPC,sum(ERec_Peso) ERec_Peso,sum(PRec_Peso) PRec_Peso
...
SELECT	@IdVersionEstabilizacion IdVersionEstabilizacion,
		t1.IdEfact,t1.IdVersionPreciosDef,t2.IdVersionPreciosPNP,t1.IdDistribuidora,t1.IdGeneradora,t1.IdCodigoContrato,t1.IdPuntoRetiro,t1.Energia,t1.Potencia,
