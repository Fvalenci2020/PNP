...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.barranacional',
        N'SCHEMA', N'dbo',
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.cetcp',
        N'SCHEMA', N'dbo',
        N'TABLE', N'cetcp'
END TRY
BEGIN CATCH
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.cmgpromedio',
        N'SCHEMA', N'dbo',
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.codigocontrato',
        N'SCHEMA', N'dbo',
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.decreto',
        N'SCHEMA', N'dbo',
        N'TABLE', N'decreto'
END TRY
BEGIN CATCH
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.demanda',
        N'SCHEMA', N'dbo',
        N'TABLE', N'demanda'
END TRY
BEGIN CATCH
...
(
   ...
   */
   ...
   [FisicoPtoRetiro] float(24)  NULL,
   [ValorizadoPtoRetiro] float(24)  NULL,
   [FisicoPtoCompra] float(24)  NULL,
   [ValorizadoPtoCompra] float(24)  NULL,
   [DiferenciaMensual] float(24)  NULL,
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.difxcompras',
        N'SCHEMA', N'dbo',
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.distribuidora',
        N'SCHEMA', N'dbo',
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.dolarfijacion',
        N'SCHEMA', N'dbo',
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.eadjanual',
        N'SCHEMA', N'dbo',
        N'TABLE', N'eadjanual'
END TRY
BEGIN CATCH
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.eadjanualdistrmensual',
        N'SCHEMA', N'dbo',
...
(
   ...
   */
   ...
   [Energia] float(24)  NULL,
   [Potencia] float(24)  NULL,
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.efact',
        N'SCHEMA', N'dbo',
        N'TABLE', N'efact'
END TRY
BEGIN CATCH
...
(
   ...
   [Fecha] date  NULL,
   [IPC] float(24)  NULL,
   [VariacionIPC] float(24)  NULL,
   [Intereses] float(24)  NULL,
   [DolarEstabilizacion] float(24)  NULL,
   [FactorAjusteE] float(24)  NULL,
   [FactorAjusteP] float(24)  NULL,
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.estabilizacion',
        N'SCHEMA', N'dbo',
...
(
   ...
   */
   ...
   [EPC_PrecioDef] float(24)  NULL,
   [PPC_PrecioDef] float(24)  NULL,
   [ERec_Peso_PrecioDef] float(24)  NULL,
   [PRec_Peso_PrecioDef] float(24)  NULL,
   ...
   */
   ...
   [EPC_PrecioPNP] float(24)  NULL,
   [PPC_PrecioPNP] float(24)  NULL,
   [ERec_Peso_PrecioPNP] float(24)  NULL,
   [PRec_Peso_PrecioPNP] float(24)  NULL,
   [VariacionIPC] float(24)  NULL,
   [Interes] float(24)  NULL,
   [FactorAjusteE] float(24)  NULL,
   [FactorAjusteP] float(24)  NULL,
   [DolarEstabilizacion] float(24)  NULL,
   [DifERec_Peso] float(24)  NULL,
   [DifPRec_Peso] float(24)  NULL,
   [DifERec_Peso_Estabilizado] float(24)  NULL,
   [DifPRec_Peso_Estabilizado] float(24)  NULL,
   [DifERec_Dolar_Estabilizado] float(24)  NULL,
   [DifPRec_Dolar_Estabilizado] float(24)  NULL
)
WITH (DATA_COMPRESSION = NONE)
GO
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.estabilizaciondetalle',
        N'SCHEMA', N'dbo',
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.factormodulacion',
        N'SCHEMA', N'dbo',
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.factorreferenciacion',
        N'SCHEMA', N'dbo',
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.generadora',
        N'SCHEMA', N'dbo',
...
(
   ...
   */
   ...
   [FechaBase] date  NULL,
   [ValorBase] float(24)  NULL,
   [FEchaActual] date  NULL,
   [ValorActual] float(24)  NULL,
   [FactorIndexacion] float(24)  NULL,
   [ValorCET] float(24)  NULL
)
WITH (DATA_COMPRESSION = NONE)
GO
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.indexacioncet',
        N'SCHEMA', N'dbo',
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.indexacioncombustible',
        N'SCHEMA', N'dbo',
...
(
   ...
   */
   ...
   [PrecioEnergiaBase] float(24)  NULL,
   ...
   */
   ...
   [PrecioPotenciaBase] float(24)  NULL,
   [FactorIndexacionPotencia] float(24)  NULL,
   [FactorIndexacionEnergia] float(24)  NULL,
   [PrecioEnergiaIndexado] float(24)  NULL,
   [PrecioPotenciaIndexado] float(24)  NULL,
   ...
   */
   ...
   [PrecioEnergiaFijacion] float(24)  NULL,
   [PrecioPotenciaFijacion] float(24)  NULL,
   [VariacionE] float(24)  NULL,
   [VariacionP] float(24)  NULL,
   [IndexE] float(24)  NULL,
   [IndexP] float(24)  NULL,
   [PrecioEnergia] float(24)  NULL,
   [PrecioPotencia] float(24)  NULL,
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.indexacioncontrato',
        N'SCHEMA', N'dbo',
...
(
   ...
   */
   ...
   [MesReferencia] date  NULL,
   [Rezago] int  NULL,
   [Ponderador] float(24)  NULL,
   [FechaBase] date  NULL,
   [ValorBase] float(24)  NULL,
   [FechaActual] date  NULL,
   [ValorActual] float(24)  NULL,
   [FactorIndexacion] float(24)  NULL,
   [PrecioIndexadoPonderado] float(24)  NULL,
   [FlagInd] int  NULL,
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.indexacioncontratodetalle',
        N'SCHEMA', N'dbo',
...
(
   ...
   */
   ...
   [FMEOferta] float(24)  NULL,
   [FMPOferta] float(24)  NULL,
   [FMESuministro] float(24)  NULL,
   [FMPSuministro] float(24)  NULL,
   [PNELP] float(24)  NULL,
   [PNPLP] float(24)  NULL,
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.indexacioncontratofm',
        N'SCHEMA', N'dbo',
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.indexacioncpi',
        N'SCHEMA', N'dbo',
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.indexaciondolar',
        N'SCHEMA', N'dbo',
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.indexacionipc',
        N'SCHEMA', N'dbo',
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.indexadorescontratos',
        N'SCHEMA', N'dbo',
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.licitacion',
        N'SCHEMA', N'dbo',
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.licitaciondx',
        N'SCHEMA', N'dbo',
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.licitaciongx',
        N'SCHEMA', N'dbo',
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.licitaciongxdxptocompra',
        N'SCHEMA', N'dbo',
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.licitaciongxindexacion',
        N'SCHEMA', N'dbo',
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.licitaciongxindexesp',
        N'SCHEMA', N'dbo',
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.perdidazonal',
        N'SCHEMA', N'dbo',
...
(
   ...
   */
   ...
   [PrecioNudoE_Peso] float(24)  NOT NULL,
   [PrecioNudoP_Peso] float(24)  NOT NULL,
   [FME] float(24)  NOT NULL,
   [FMP] float(24)  NOT NULL,
...
(
   ...
   */
   ...
   [IdGeneradora] int  NOT NULL,
   [IdDistribuidora] int  NOT NULL,
   [CETDolar] float(24)  NULL,
   [ValorDolar] float(24)  NULL,
   [PrecioNudoEnergiaDolar] float(24)  NULL,
   [PrecioNudoPotenciaDolar] float(24)  NULL
)
WITH (DATA_COMPRESSION = NONE)
GO
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.pncpconcet',
        N'SCHEMA', N'dbo',
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.pnpindex',
        N'SCHEMA', N'dbo',
        N'TABLE', N'pnpindex'
END TRY
BEGIN CATCH
...
(
   ...
   */
   ...
   [CMGPtoSuministro] float(24)  NULL,
   [CMGPtoOferta] float(24)  NULL,
   [PeTraspExc] float(24)  NULL
)
WITH (DATA_COMPRESSION = NONE)
GO
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.pnptraspexc',
        N'SCHEMA', N'dbo',
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.precionudolicitacion',
        N'SCHEMA', N'dbo',
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.ptoretirosistema',
        N'SCHEMA', N'dbo',
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.puntoretiro',
        N'SCHEMA', N'dbo',
...
(
   ...
   */
   ...
   [CETCP] float(24)  NULL,
   [PNECP_USD] float(24)  NULL,
   [PNPCP_USD] float(24)  NULL,
   [EPC] float(24)  NULL,
   [PPC] float(24)  NULL,
   [ERec_USD] float(24)  NULL,
   [PRec_USD] float(24)  NULL,
   [Dolar] float(24)  NULL,
   [ERec_Peso] float(24)  NULL,
   [PRec_Peso] float(24)  NULL
)
WITH (DATA_COMPRESSION = NONE)
GO
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.recaudaciondetalle',
        N'SCHEMA', N'dbo',
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.sistemazonal',
        N'SCHEMA', N'dbo',
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.tipocombustible',
        N'SCHEMA', N'dbo',
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.tipodespacho',
        N'SCHEMA', N'dbo',
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.versionefact',
        N'SCHEMA', N'dbo',
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.versionestabilizacion',
        N'SCHEMA', N'dbo',
...
USE PNP_2
GO
IF EXISTS (SELECT * FROM sys.objects so JOIN sys.schemas sc ON so.schema_id = sc.schema_id WHERE so.name = N'versionindexacion'  AND sc.name = N'dbo'  AND type in (N'U'))
BEGIN
  ...
  DECLARE drop_cursor CURSOR FOR
      ...
      WHERE fk.referenced_object_id = 
          (
             ...
             FROM sys.objects so JOIN sys.schemas sc
             ON so.schema_id = sc.schema_id
             WHERE so.name = N'versionindexacion'  AND sc.name = N'dbo'  AND type in (N'U')
           )
  ...
  DROP TABLE [dbo].[versionindexacion]
END 
GO
...
GO
CREATE TABLE 
[dbo].[versionindexacion]
(
   [IdVersionIndexacion] int  NOT NULL,
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.versionindexacion',
        N'SCHEMA', N'dbo',
        N'TABLE', N'versionindexacion'
END TRY
BEGIN CATCH
    IF (@@TRANCOUNT > 0) ROLLBACK
    PRINT ERROR_MESSAGE()
...
USE PNP_2
GO
IF EXISTS (SELECT * FROM sys.objects so JOIN sys.schemas sc ON so.schema_id = sc.schema_id WHERE so.name = N'versionindexaciondetalle'  AND sc.name = N'dbo'  AND type in (N'U'))
BEGIN
  ...
  DECLARE drop_cursor CURSOR FOR
      ...
      WHERE fk.referenced_object_id = 
          (
             ...
             FROM sys.objects so JOIN sys.schemas sc
             ON so.schema_id = sc.schema_id
             WHERE so.name = N'versionindexaciondetalle'  AND sc.name = N'dbo'  AND type in (N'U')
           )
  ...
  DROP TABLE [dbo].[versionindexaciondetalle]
END 
GO
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.versionindexaciondetalle',
        N'SCHEMA', N'dbo',
        N'TABLE', N'versionindexaciondetalle'
END TRY
BEGIN CATCH
    IF (@@TRANCOUNT > 0) ROLLBACK
    PRINT ERROR_MESSAGE()
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.versionrec',
        N'SCHEMA', N'dbo',
...
BEGIN TRY
    EXEC sp_addextendedproperty
        N'MS_SSMA_SOURCE', N'pnp_2.versionrecdetalle',
        N'SCHEMA', N'dbo',
...
USE PNP_2
GO
IF EXISTS (SELECT * FROM sys.objects so JOIN sys.schemas sc ON so.schema_id = sc.schema_id WHERE so.name = N'PK_versionindexacion_IdVersionIndexacion'  AND sc.name = N'dbo'  AND type in (N'PK'))
ALTER TABLE [dbo].[versionindexacion] DROP CONSTRAINT [PK_versionindexacion_IdVersionIndexacion]
 GO



ALTER TABLE [dbo].[versionindexacion]
 ADD CONSTRAINT [PK_versionindexacion_IdVersionIndexacion]
   PRIMARY KEY
   CLUSTERED ([IdVersionIndexacion] ASC)
...
USE PNP_2
GO
IF EXISTS (SELECT * FROM sys.objects so JOIN sys.schemas sc ON so.schema_id = sc.schema_id WHERE so.name = N'PK_versionindexaciondetalle_Registro'  AND sc.name = N'dbo'  AND type in (N'PK'))
ALTER TABLE [dbo].[versionindexaciondetalle] DROP CONSTRAINT [PK_versionindexaciondetalle_Registro]
 GO



ALTER TABLE [dbo].[versionindexaciondetalle]
 ADD CONSTRAINT [PK_versionindexaciondetalle_Registro]
   PRIMARY KEY
   CLUSTERED ([Registro] ASC, [IdVersionIndexacion] ASC)
...
IF EXISTS (
       ...
       JOIN sys.schemas sc
       ON so.schema_id = sc.schema_id
       WHERE so.name = N'versionindexaciondetalle'  AND sc.name = N'dbo'  AND si.name = N'fk_VersionIndexacionDetalle_VersionIndexacion1_idx' AND so.type in (N'U'))
   DROP INDEX [fk_VersionIndexacionDetalle_VersionIndexacion1_idx] ON [dbo].[versionindexaciondetalle] 
GO
CREATE NONCLUSTERED INDEX [fk_VersionIndexacionDetalle_VersionIndexacion1_idx] ON [dbo].[versionindexaciondetalle]
(
   [IdVersionIndexacion] ASC
)
WITH (SORT_IN_TEMPDB = OFF, DROP_EXISTING = OFF, IGNORE_DUP_KEY = OFF, ONLINE = OFF) ON [PRIMARY] 
GO
GO
...
ALTER TABLE [dbo].[cet]
 ...
 FOREIGN KEY 
   ([IdGeneradora])
 REFERENCES 
   [PNP_2].[dbo].[generadora]     ([IdGeneradora])
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
...
ALTER TABLE [dbo].[cet]
 ...
 FOREIGN KEY 
   ([IdLicitacionDx])
 REFERENCES 
   [PNP_2].[dbo].[licitaciondx]     ([IdLicitacionDx])
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
...
ALTER TABLE [dbo].[cetcp]
 ...
 FOREIGN KEY 
   ([IdDistribuidora])
 REFERENCES 
   [PNP_2].[dbo].[distribuidora]     ([IdDistribuidora])
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
...
ALTER TABLE [dbo].[cmgpromedio]
 ...
 FOREIGN KEY 
   ([IdBarraNacional])
 REFERENCES 
   [PNP_2].[dbo].[barranacional]     ([IdBarraNacional])
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
...
ALTER TABLE [dbo].[codigocontrato]
 ...
 FOREIGN KEY 
   ([IdLicitacion])
 REFERENCES 
   [PNP_2].[dbo].[licitacion]     ([IdLicitacion])
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
...
ALTER TABLE [dbo].[demanda]
 ...
 FOREIGN KEY 
   ([IdPuntoRetiro])
 REFERENCES 
   [PNP_2].[dbo].[puntoretiro]     ([IdPuntoRetiro])
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
...
ALTER TABLE [dbo].[demanda]
 ...
 FOREIGN KEY 
   ([IdSistemaZonal])
 REFERENCES 
   [PNP_2].[dbo].[sistemazonal]     ([IdSistemaZonal])
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
...
ALTER TABLE [dbo].[difxcompras]
 ...
 FOREIGN KEY 
   ([IdCodigoContrato])
 REFERENCES 
   [PNP_2].[dbo].[codigocontrato]     ([IdCodigoContrato])
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
...
ALTER TABLE [dbo].[efact]
 ...
 FOREIGN KEY 
   ([IdTipoDespacho])
 REFERENCES 
   [PNP_2].[dbo].[tipodespacho]     ([IdTipoDEspacho])
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
...
ALTER TABLE [dbo].[efact]
 ...
 FOREIGN KEY 
   ([IdVersion])
 REFERENCES 
   [PNP_2].[dbo].[versionefact]     ([IdVersion])
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
...
ALTER TABLE [dbo].[estabilizaciondetalle]
 ...
 REFERENCES 
   [PNP_2].[dbo].[versionestabilizacion]     ([IdVersionEstabilizacion])
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
...
ALTER TABLE [dbo].[indexacioncet]
 ...
 REFERENCES 
   [PNP_2].[dbo].[cet]     ([IdLicitacionDx], [IdGeneradora])
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
...
ALTER TABLE [dbo].[indexacioncombustible]
 ...
 FOREIGN KEY 
   ([IdTipoCombustible])
 REFERENCES 
   [PNP_2].[dbo].[tipocombustible]     ([IdTipoCombustible])
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
...
ALTER TABLE [dbo].[indexacioncontrato]
 ...
 FOREIGN KEY 
   ([IdLicitacionGx])
 REFERENCES 
   [PNP_2].[dbo].[licitaciongx]     ([IdLicitacionGx])
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
...
ALTER TABLE [dbo].[pncpconcet]
 ...
 REFERENCES 
   [PNP_2].[dbo].[cetcp]     ([MesIndexacion], [VersionIndex], [Version], [IdGeneradora], [IdDistribuidora])
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
...
ALTER TABLE [dbo].[pncpconcet]
 ...
 REFERENCES 
   [PNP_2].[dbo].[pncp]     ([MES], [Version], [IdNudo])
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
...
ALTER TABLE [dbo].[pncpconcet]
 ...
 FOREIGN KEY 
   ([IdVersion])
 REFERENCES 
   [PNP_2].[dbo].[versionrec]     ([IdVersion])
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
...
ALTER TABLE [dbo].[pnptraspexc]
 ...
 REFERENCES 
   [PNP_2].[dbo].[cmgpromedio]     ([VersionCMg], [Fecha], [IdBarraNacional])
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
...
ALTER TABLE [dbo].[pnptraspexc]
 ...
 REFERENCES 
   [PNP_2].[dbo].[pnpindex]     ([VersionIndex], [MesIndexacion], [Version], [IdCodigoContrato], [IdPtoOferta])
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
...
ALTER TABLE [dbo].[recaudaciondetalle]
 ...
 REFERENCES 
   [PNP_2].[dbo].[perdidazonal]     ([Fecha], [Version], [IdSistemaZonal])
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
...
ALTER TABLE [dbo].[recaudaciondetalle]
 ...
 REFERENCES 
   [PNP_2].[dbo].[factorreferenciacion]     ([IdPuntoRetiro], [IdBarraNacional], [Periodo])
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
...
USE PNP_2
GO
IF EXISTS (SELECT * FROM sys.objects so JOIN sys.schemas sc ON so.schema_id = sc.schema_id WHERE so.name = N'versionindexaciondetalle$fk_VersionIndexacionDetalle_VersionIndexacion1'  AND sc.name = N'dbo'  AND type in (N'F'))
ALTER TABLE [dbo].[versionindexaciondetalle] DROP CONSTRAINT [versionindexaciondetalle$fk_VersionIndexacionDetalle_VersionIndexacion1]
 GO



ALTER TABLE [dbo].[versionindexaciondetalle]
 ADD CONSTRAINT [versionindexaciondetalle$fk_VersionIndexacionDetalle_VersionIndexacion1]
 FOREIGN KEY 
   ([IdVersionIndexacion])
 REFERENCES 
   [PNP_2].[dbo].[versionindexacion]     ([IdVersionIndexacion])
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
